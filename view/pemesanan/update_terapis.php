...
$cek_pesan = mysqli_query($link, "SELECT * from pesan where kode_pesanan = '$kode_pesanan'");
$hasil_cek = mysqli_fetch_array($cek_pesan);
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-body box-profile">
              <h4>
                  <marquee behavior="scroll" direction="left"> <?= $kode_pesanan ?> |
            ...
            <div class="col-md-7">
              <table class="table table-striped table-bordered table-sm " cellspacing="0"
               width="100%">
                <form action="../../controller/pesan/edit_pesan.php?id_terapis=<?= $id_terapis ?>" method="POST" name="fSimpanHa">
                <thead>
                  <tr>
                    ...
                    <?php
                      $selek_data = mysqli_query($link, "SELECT
                                                        ...
                                                        FROM
                                                          waktu_pesan
                                                        WHERE
                                                          waktu NOT IN ( SELECT durasi FROM durasi WHERE id_terapis = '$id_terapis' && status_durasi = '0') 
                                                        ORDER BY id ASC");
                        ...
                        <div class="modal-content" style="width: 90%">
                         <div class="modal-header">
                            ...
                            <div class="modal-body">
                              <div class="fetched-data">
                                  <div class="form-group">
                                    ...
                                    <input type="text" name="kode_pesanan" value="<?= $kode_pesanan ?>" class="form-control" readonly="" />
                                    <input type="hidden" name="id_terapis" value="<?= $id_terapis ?>"/>
                                  </div>
                                  <div class="form-group">
                                    <label>Nama Pelanggan <font color="red">*</font></label>
                                    <input type="text" name="nama_pelanggan" value="<?= $hasil_cek[nama_pemesan] ?>" class="form-control" autocomplete="off" required=""/>
                                  </div>
                                  <div class="form-group">
                                    <label>Alamat Pelanggan <font color="red">*</font></label>
                                    <input type="text" name="alamat_pelanggan" value="<?= $hasil_cek[alamat] ?>" class="form-control" autocomplete="off" placeholder="Simpang Tiga" required=""/>
                                  </div>
                                  <div class="form-group">
                            ...
                            <div class="modal-footer">
                              ...
                              <button type="submit" name="edit_terapis" class="btn btn-primary">Tambah Data</button>
                            </div>
                          </div>
                        </div>
                      </div>
